...
namespace Comex.Testes
{
    public class TestaValidacaoDeProdutos
    {
        public static void RegistaEntradaProdutos()
        {
            try
            {
                Produto teste1 = new(0, "Notebook Samsung", 3523.00, 1, "Informática");
            ...
            try
            {
                Produto teste2 = new(31, "Clean", 102.90, 2, "Livros");
            ...
            try
            {
                Produto teste4 = new(33, "Código Limpo", 102.90, 0, "Livros");
            ...
            try
            {
                Produto teste5 = new(34, "mouse pad", 50.00, 3, "");
        ...
        public static void RegistaEntradaProdutosIsentos()
        {
            try
            {
                ProdutoIsento teste1 = new(0, "Vacina", 250.00, 1000, "Saúde");
            ...
            try
            {
                ProdutoIsento teste2 = new(41, "Java", 112.90, 5, "Livros");
            ...
            try
            {
                ProdutoIsento teste4 = new(43, "Luvas Descartáveis", 250.00, 0, "Saúde");
            ...
            try
            {
                ProdutoIsento teste5 = new(44, "Algoritmos e Lógica da Programação", 112.90, 5, "");
