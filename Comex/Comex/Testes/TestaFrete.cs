...
namespace Comex.Testes
{
    public class TestaFrete
    {
        ...
        Console.WriteLine($"CEP: {pedido1.Frete.Correios.Cep} - Frete: R${pedido1.Frete.Calcular()}");
        Console.WriteLine($"CEP: {pedido2.Frete.Correios.Cep} - Frete: R${pedido1.Frete.Calcular()}");
        Console.WriteLine($"CEP: {pedido3.Frete.Correios.Cep} - Frete: R${pedido1.Frete.Calcular()}");
    }
}
*/
